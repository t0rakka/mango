...
namespace mango
{
    ...
    enum : u64
    {
        ...
        INTEL_AVX512F     = 0x0000000008000000,
        INTEL_AVX512PFI   = 0x0000000010000000,
        INTEL_AVX512ERI   = 0x0000000020000000,
        INTEL_AVX512CDI   = 0x0000000040000000,
        INTEL_AVX512BW    = 0x0000000080000000,
        INTEL_AVX512VL    = 0x0000000100000000,
        INTEL_AVX512DQ    = 0x0000000200000000,
        INTEL_AVX512IFMA  = 0x0000000400000000,
        INTEL_AVX512VBMI  = 0x0000000800000000,
        INTEL_LZCNT       = 0x0000001000000000,
