...
GLEXT_PROC(PFNGLGETFRAGMENTSHADINGRATESEXTPROC, glGetFragmentShadingRatesEXT);
GLEXT_PROC(PFNGLSHADINGRATEEXTPROC, glShadingRateEXT);
GLEXT_PROC(PFNGLSHADINGRATECOMBINEROPSEXTPROC, glShadingRateCombinerOpsEXT);
GLEXT_PROC(PFNGLFRAMEBUFFERSHADINGRATEEXTPROC, glFramebufferShadingRateEXT);

// GL_EXT_framebuffer_blit
GLEXT_PROC(PFNGLBLITFRAMEBUFFEREXTPROC, glBlitFramebufferEXT);

// GL_EXT_framebuffer_blit_layers
GLEXT_PROC(PFNGLBLITFRAMEBUFFERLAYERSEXTPROC, glBlitFramebufferLayersEXT);
GLEXT_PROC(PFNGLBLITFRAMEBUFFERLAYEREXTPROC, glBlitFramebufferLayerEXT);
...
// GL_EXT_mesh_shader
GLEXT_PROC(PFNGLDRAWMESHTASKSEXTPROC, glDrawMeshTasksEXT);
GLEXT_PROC(PFNGLDRAWMESHTASKSINDIRECTEXTPROC, glDrawMeshTasksIndirectEXT);
GLEXT_PROC(PFNGLMULTIDRAWMESHTASKSINDIRECTEXTPROC, glMultiDrawMeshTasksIndirectEXT);
GLEXT_PROC(PFNGLMULTIDRAWMESHTASKSINDIRECTCOUNTEXTPROC, glMultiDrawMeshTasksIndirectCountEXT);
