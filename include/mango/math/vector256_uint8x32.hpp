...
namespace mango::math
{
    ...
    MATH_SIMD_UNSIGNED_INTEGER_OPERATORS(u8, 32);

    // ------------------------------------------------------------------
    // functions
    // ------------------------------------------------------------------

    MATH_SIMD_INTEGER_FUNCTIONS(u8, 32, mask8x32);
    MATH_SIMD_SATURATING_INTEGER_FUNCTIONS(u8, 32, mask8x32);

    MATH_SIMD_BITWISE_FUNCTIONS(u8, 32);
