...
namespace mango
{
    ...
    static inline Vector<uint8, 32>::Mask operator > (Vector<uint8, 32> a, Vector<uint8, 32> b)
    {
    ...
    static inline Vector<uint8, 32> select(Vector<uint8, 32>::Mask mask, Vector<uint8, 32> a, Vector<uint8, 32> b)
    {
