...
namespace mango::math
{
    ...
    struct Vector<u16, 32>
    {
        ...
        {
            return simd::u16x32_uload(source);
        }

        static void ustore(void* dest, Vector v)
        {
            simd::u16x32_ustore(dest, v);
        }
    ...
    inline Vector<u16, 32> mullo(Vector<u16, 32> a, Vector<u16, 32> b)
    {
    ...
    inline Vector<u16, 32> operator << (Vector<u16, 32> a, int b)
    {
        return simd::sll(a, b);
    }
