...
namespace mango
{
    ...
    template <>
    struct Vector<int32, 8> : simd::VectorBase<int32, 8>
    {
        union
        {
            simd::int32x8 m;

            simd::ScalarAccessor<int32, simd::int32x8, 0> x;
            simd::ScalarAccessor<int32, simd::int32x8, 1> y;
            simd::ScalarAccessor<int32, simd::int32x8, 2> z;
            simd::ScalarAccessor<int32, simd::int32x8, 3> w;
        };
