...
namespace mango
{
    ...
    static inline Vector<uint16, 8>::Mask operator > (Vector<uint16, 8> a, Vector<uint16, 8> b)
    {
    ...
    static inline Vector<uint16, 8> select(Vector<uint16, 8>::Mask mask, Vector<uint16, 8> a, Vector<uint16, 8> b)
    {
