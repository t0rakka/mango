...
namespace mango
{
    ...
    struct Vector<double, 2> : VectorBase<double, 2>
    {
        ...
        using Mask = simd::float64x2::mask;
    ...
    static inline double2::Mask operator > (double2 a, double2 b)
    {
    ...
    static inline double2 select(double2::Mask mask, double2 a, double2 b)
    {
