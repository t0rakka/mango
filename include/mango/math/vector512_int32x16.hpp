...
namespace mango::math
{
    ...
    struct Vector<s32, 16>
    {
        ...
        {
            return simd::s32x16_uload(source);
        }

        static void ustore(void* dest, Vector v)
        {
            simd::s32x16_ustore(dest, v);
        }
    ...
    inline Vector<s32, 16> mullo(Vector<s32, 16> a, Vector<s32, 16> b)
    {
    ...
    inline Vector<s32, 16> operator << (Vector<s32, 16> a, int b)
    {
        return simd::sll(a, b);
    }
    ...
    inline Vector<s32, 16> operator << (Vector<s32, 16> a, Vector<u32, 16> b)
    {
        return simd::sll(a, b);
    }
