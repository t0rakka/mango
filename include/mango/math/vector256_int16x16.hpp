...
namespace mango
{
    ...
    static inline Vector<int16, 16>::Mask operator > (Vector<int16, 16> a, Vector<int16, 16> b)
    {
    ...
    static inline Vector<int16, 16> select(Vector<int16, 16>::Mask mask, Vector<int16, 16> a, Vector<int16, 16> b)
    {
