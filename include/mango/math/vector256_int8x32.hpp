...
namespace mango
{
    ...
    static inline Vector<int8, 32>::Mask operator > (Vector<int8, 32> a, Vector<int8, 32> b)
    {
    ...
    static inline Vector<int8, 32> select(Vector<int8, 32>::Mask mask, Vector<int8, 32> a, Vector<int8, 32> b)
    {
