...
namespace mango::simd
{
    ...
    inline f32x4 set_component(f32x4 a, f32 s)
    {
    ...
    template <unsigned int Index>
    inline f32 get_component(f32x4 a);
    ...
    inline f32x4 f32x4_set(f32 s)
    {
        return _mm_set1_ps(s);
    }

    inline f32x4 f32x4_set(f32 x, f32 y, f32 z, f32 w)
    {
        return _mm_setr_ps(x, y, z, w);
    }

    inline f32x4 f32x4_uload(const void* source)
    {
        return _mm_loadu_ps(reinterpret_cast<const f32*>(source));
    }

    inline void f32x4_ustore(void* dest, f32x4 a)
    {
        _mm_storeu_ps(reinterpret_cast<f32*>(dest), a);
    }

    inline f32x4 movelh(f32x4 a, f32x4 b)
    {
        return _mm_movelh_ps(a, b);
    }

    inline f32x4 movehl(f32x4 a, f32x4 b)
    {
        return _mm_movehl_ps(a, b);
    }

    inline f32x4 unpackhi(f32x4 a, f32x4 b)
    {
        return _mm_unpackhi_ps(a, b);
    }

    inline f32x4 unpacklo(f32x4 a, f32x4 b)
    {
    ...
    inline f32x4 bitwise_nand(f32x4 a, f32x4 b)
    {
        return _mm_andnot_ps(a, b);
    }

    inline f32x4 bitwise_and(f32x4 a, f32x4 b)
    {
        return _mm_and_ps(a, b);
    }

    inline f32x4 bitwise_or(f32x4 a, f32x4 b)
    {
        return _mm_or_ps(a, b);
    }

    inline f32x4 bitwise_xor(f32x4 a, f32x4 b)
    {
        return _mm_xor_ps(a, b);
    }

    inline f32x4 bitwise_not(f32x4 a)
    {
    ...
    inline f32x4 abs(f32x4 a)
    {
        return _mm_max_ps(a, _mm_sub_ps(_mm_setzero_ps(), a));
    }

    inline f32x4 neg(f32x4 a)
    {
        return _mm_sub_ps(_mm_setzero_ps(), a);
    }

    inline f32x4 sign(f32x4 a)
    {
    ...
    inline f32x4 div(f32x4 a, f32x4 b)
    {
    ...
    inline f32x4 div(f32x4 a, f32 b)
    {
        return _mm_div_ps(a, _mm_set1_ps(b));
    }

    inline f32x4 hadd(f32x4 a, f32x4 b)
    {
        return _mm_hadd_ps(a, b);
    }

    inline f32x4 hsub(f32x4 a, f32x4 b)
    {
    ...
    inline f32x4 madd(f32x4 a, f32x4 b, f32x4 c)
    {
        // a + b * c
        return _mm_fmadd_ps(b, c, a);
    }

    inline f32x4 msub(f32x4 a, f32x4 b, f32x4 c)
    {
        // b * c - a
        return _mm_fmsub_ps(b, c, a);
    }

    inline f32x4 nmadd(f32x4 a, f32x4 b, f32x4 c)
    {
        // a - b * c
        return _mm_fnmadd_ps(b, c, a);
    }

    inline f32x4 nmsub(f32x4 a, f32x4 b, f32x4 c)
    {
        // -(a + b * c)
    ...
    inline f32x4 lerp(f32x4 a, f32x4 b, f32x4 s)
    {
        // a * (1.0 - s) + b * s
        // (a - a * s) + (b * s)
    ...
    inline f32x4 sqrt(f32x4 a)
    {
        return _mm_sqrt_ps(a);
    }

    inline f32 dot3(f32x4 a, f32x4 b)
    {
        f32x4 s = _mm_dp_ps(a, b, 0x7f);
        return get_component<0>(s);
    }

    inline f32 dot4(f32x4 a, f32x4 b)
    {
        f32x4 s = _mm_dp_ps(a, b, 0xff);
        return get_component<0>(s);
    }

    inline f32x4 cross3(f32x4 a, f32x4 b)
    {
    ...
    inline mask32x4 compare_neq(f32x4 a, f32x4 b)
    {
        return _mm_cmp_ps_mask(a, b, _CMP_NEQ_UQ);
    }

    inline mask32x4 compare_eq(f32x4 a, f32x4 b)
    {
        return _mm_cmp_ps_mask(a, b, _CMP_EQ_OQ);
    }

    inline mask32x4 compare_lt(f32x4 a, f32x4 b)
    {
        return _mm_cmp_ps_mask(a, b, _CMP_LT_OS);
    }

    inline mask32x4 compare_le(f32x4 a, f32x4 b)
    {
        return _mm_cmp_ps_mask(a, b, _CMP_LE_OS);
    }

    inline mask32x4 compare_gt(f32x4 a, f32x4 b)
    {
        return _mm_cmp_ps_mask(b, a, _CMP_LT_OS);
    }

    inline mask32x4 compare_ge(f32x4 a, f32x4 b)
    {
        return _mm_cmp_ps_mask(b, a, _CMP_LE_OS);
    }

    inline f32x4 select(mask32x4 mask, f32x4 a, f32x4 b)
    {
    ...
    template <u32 x, u32 y>
    inline f64x2 shuffle(f64x2 a, f64x2 b)
    {
        static_assert(x < 2 && y < 2, "Index out of range.");
    ...
    template <unsigned int Index>
    inline f64x2 set_component(f64x2 a, double s);
    ...
    template <unsigned int Index>
    inline double get_component(f64x2 a);
    ...
    inline f64x2 f64x2_zero()
    {
        return _mm_setzero_pd();
    }

    inline f64x2 f64x2_set(double s)
    {
        return _mm_set1_pd(s);
    }

    inline f64x2 f64x2_set(double x, double y)
    {
        return _mm_setr_pd(x, y);
    }

    inline f64x2 f64x2_uload(const void* source)
    {
        return _mm_loadu_pd(reinterpret_cast<const f64*>(source));
    }

    inline void f64x2_ustore(void* dest, f64x2 a)
    {
        _mm_storeu_pd(reinterpret_cast<f64*>(dest), a);
    }

    inline f64x2 unpackhi(f64x2 a, f64x2 b)
    {
        return _mm_unpackhi_pd(a, b);
    }

    inline f64x2 unpacklo(f64x2 a, f64x2 b)
    {
    ...
    inline f64x2 bitwise_nand(f64x2 a, f64x2 b)
    {
        return _mm_andnot_pd(a, b);
    }

    inline f64x2 bitwise_and(f64x2 a, f64x2 b)
    {
        return _mm_and_pd(a, b);
    }

    inline f64x2 bitwise_or(f64x2 a, f64x2 b)
    {
        return _mm_or_pd(a, b);
    }

    inline f64x2 bitwise_xor(f64x2 a, f64x2 b)
    {
        return _mm_xor_pd(a, b);
    }

    inline f64x2 bitwise_not(f64x2 a)
    {
    ...
    inline f64x2 add(f64x2 a, f64x2 b)
    {
    ...
    inline f64x2 sub(f64x2 a, f64x2 b)
    {
    ...
    inline f64x2 div(f64x2 a, f64x2 b)
    {
    ...
    inline f64x2 div(f64x2 a, double b)
    {
        return _mm_div_pd(a, _mm_set1_pd(b));
    }

    inline f64x2 hadd(f64x2 a, f64x2 b)
    {
        return _mm_hadd_pd(a, b);
    }

    inline f64x2 hsub(f64x2 a, f64x2 b)
    {
    ...
    inline f64x2 madd(f64x2 a, f64x2 b, f64x2 c)
    {
        // a + b * c
        return _mm_fmadd_pd(b, c, a);
    }

    inline f64x2 msub(f64x2 a, f64x2 b, f64x2 c)
    {
        // b * c - a
        return _mm_fmsub_pd(b, c, a);
    }

    inline f64x2 nmadd(f64x2 a, f64x2 b, f64x2 c)
    {
        // a - b * c
        return _mm_fnmadd_pd(b, c, a);
    }

    inline f64x2 nmsub(f64x2 a, f64x2 b, f64x2 c)
    {
        // -(a + b * c)
    ...
    inline f64x2 lerp(f64x2 a, f64x2 b, f64x2 s)
    {
        // a * (1.0 - s) + b * s
        // (a - a * s) + (b * s)
        return madd(nmadd(a, a, s), b, s);
    ...
    inline f64x2 rsqrt(f64x2 a)
    {
        return _mm_div_pd(_mm_set1_pd(1.0), _mm_sqrt_pd(a));
    }

    inline f64x2 sqrt(f64x2 a)
    {
        return _mm_sqrt_pd(a);
    }

    inline double dot2(f64x2 a, f64x2 b)
    {
    ...
    inline mask64x2 compare_neq(f64x2 a, f64x2 b)
    {
        return _mm_cmp_pd_mask(a, b, _CMP_NEQ_UQ);
    }

    inline mask64x2 compare_eq(f64x2 a, f64x2 b)
    {
        return _mm_cmp_pd_mask(a, b, _CMP_EQ_OQ);
    }

    inline mask64x2 compare_lt(f64x2 a, f64x2 b)
    {
        return _mm_cmp_pd_mask(a, b, _CMP_LT_OS);
    }

    inline mask64x2 compare_le(f64x2 a, f64x2 b)
    {
        return _mm_cmp_pd_mask(a, b, _CMP_LE_OS);
    }

    inline mask64x2 compare_gt(f64x2 a, f64x2 b)
    {
        return _mm_cmp_pd_mask(b, a, _CMP_LT_OS);
    }

    inline mask64x2 compare_ge(f64x2 a, f64x2 b)
    {
        return _mm_cmp_pd_mask(b, a, _CMP_LE_OS);
    }

    inline f64x2 select(mask64x2 mask, f64x2 a, f64x2 b)
    {
