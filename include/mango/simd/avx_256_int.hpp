...
#define SIMD_COMPOSITE_FUNC2(R, AB, FUNC) \
    ...
    inline mask8x16 get_low(mask8x32 a)
    {
        return _mm256_extractf128_si256(a, 0);
    }

    inline mask8x16 get_high(mask8x32 a)
    {
        return _mm256_extractf128_si256(a, 1);
    }

    inline mask16x8 get_low(mask16x16 a)
    {
        return _mm256_extractf128_si256(a, 0);
    }

    inline mask16x8 get_high(mask16x16 a)
    {
        return _mm256_extractf128_si256(a, 1);
    }

    inline mask32x4 get_low(mask32x8 a)
    {
        return _mm256_extractf128_si256(a, 0);
    }

    inline mask32x4 get_high(mask32x8 a)
    {
        return _mm256_extractf128_si256(a, 1);
    }

    inline mask64x2 get_low(mask64x4 a)
    {
        return _mm256_extractf128_si256(a, 0);
    }

    inline mask64x2 get_high(mask64x4 a)
    {
        return _mm256_extractf128_si256(a, 1);
    }

    inline mask8x32 combine(mask8x16 lo, mask8x16 hi)
    {
        return _mm256_insertf128_si256(_mm256_castsi128_si256(lo), hi, 1);
    }

    inline mask16x16 combine(mask16x8 lo, mask16x8 hi)
    {
        return _mm256_insertf128_si256(_mm256_castsi128_si256(lo), hi, 1);
    }

    inline mask32x8 combine(mask32x4 lo, mask32x4 hi)
    {
        return _mm256_insertf128_si256(_mm256_castsi128_si256(lo), hi, 1);
    }
...
namespace mango::simd
{
    ...
    inline u64x4 shuffle(u64x4 v)
    {
        ...
        __m128i low = _mm_castpd_si128(_mm_shuffle_pd(
            _mm_castsi128_pd(v.data[x >> 1]), 
            _mm_castsi128_pd(v.data[y >> 1]),
            ((y & 1) << 1) | (x & 1)));
        __m128i high = _mm_castpd_si128(_mm_shuffle_pd(
            _mm_castsi128_pd(v.data[z >> 1]), 
            _mm_castsi128_pd(v.data[w >> 1]), 
            ((w & 1) << 1) | (z & 1)));
