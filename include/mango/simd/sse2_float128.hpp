...
namespace simd {
    ...
    template <>
    inline f32x4 set_component<0>(f32x4 a, float x)
    {
    ...
    template <>
    inline f32x4 set_component<1>(f32x4 a, float y)
    {
    ...
    template <>
    inline f32x4 set_component<2>(f32x4 a, float z)
    {
    ...
    template <>
    inline f32x4 set_component<3>(f32x4 a, float w)
    {
