...
namespace mango::simd
{
    ...
    inline f32x8 unpackhi(f32x8 a, f32x8 b)
    {
        return _mm256_unpackhi_ps(a, b);
    }

    inline f32x8 unpacklo(f32x8 a, f32x8 b)
    {
    ...
    inline f32x8 bitwise_nand(f32x8 a, f32x8 b)
    {
        return _mm256_andnot_ps(a, b);
    }

    inline f32x8 bitwise_and(f32x8 a, f32x8 b)
    {
         return _mm256_and_ps(a, b);
    }

    inline f32x8 bitwise_or(f32x8 a, f32x8 b)
    {
         return _mm256_or_ps(a, b);
    }

    inline f32x8 bitwise_xor(f32x8 a, f32x8 b)
    {
         return _mm256_xor_ps(a, b);
    }

    inline f32x8 bitwise_not(f32x8 a)
    {
    ...
    inline f32x8 hadd(f32x8 a, f32x8 b)
    {
        return _mm256_hadd_ps(a, b);
    }

    inline f32x8 hsub(f32x8 a, f32x8 b)
    {
    ...
    inline f32x8 madd(f32x8 a, f32x8 b, f32x8 c)
    {
        // a + b * c
        return _mm256_fmadd_ps(b, c, a);
    }

    inline f32x8 msub(f32x8 a, f32x8 b, f32x8 c)
    {
        // b * c - a
        return _mm256_fmsub_ps(b, c, a);
    }

    inline f32x8 nmadd(f32x8 a, f32x8 b, f32x8 c)
    {
        // a - b * c
        return _mm256_fnmadd_ps(b, c, a);
    }

    inline f32x8 nmsub(f32x8 a, f32x8 b, f32x8 c)
    {
        // -(a + b * c)
    ...
    inline f32x8 lerp(f32x8 a, f32x8 b, f32x8 s)
    {
        // a * (1.0 - s) + b * s
        // (a - a * s) + (b * s)
    ...
    inline f32x8 rcp(f32x8 a)
    {
        return _mm256_rcp_ps(a);
    }

    inline f32x8 rsqrt(f32x8 a)
    {
    ...
    inline f32x8 min(f32x8 a, f32x8 b, mask32x8 mask)
    {
        return _mm256_and_ps(_mm256_castsi256_ps(mask), min(a, b));
    }

    inline f32x8 max(f32x8 a, f32x8 b, mask32x8 mask)
    {
        return _mm256_and_ps(_mm256_castsi256_ps(mask), max(a, b));
    }

    inline f32x8 add(f32x8 a, f32x8 b, mask32x8 mask)
    {
        return _mm256_and_ps(_mm256_castsi256_ps(mask), add(a, b));
    }

    inline f32x8 sub(f32x8 a, f32x8 b, mask32x8 mask)
    {
        return _mm256_and_ps(_mm256_castsi256_ps(mask), sub(a, b));
    }

    inline f32x8 mul(f32x8 a, f32x8 b, mask32x8 mask)
    {
        return _mm256_and_ps(_mm256_castsi256_ps(mask), mul(a, b));
    }

    inline f32x8 div(f32x8 a, f32x8 b, mask32x8 mask)
    {
    ...
    inline f32x8 min(f32x8 a, f32x8 b, mask32x8 mask, f32x8 value)
    {
        return select(mask, min(a, b), value);
    }

    inline f32x8 max(f32x8 a, f32x8 b, mask32x8 mask, f32x8 value)
    {
        return select(mask, max(a, b), value);
    }

    inline f32x8 add(f32x8 a, f32x8 b, mask32x8 mask, f32x8 value)
    {
        return select(mask, add(a, b), value);
    }

    inline f32x8 sub(f32x8 a, f32x8 b, mask32x8 mask, f32x8 value)
    {
        return select(mask, sub(a, b), value);
    }

    inline f32x8 mul(f32x8 a, f32x8 b, mask32x8 mask, f32x8 value)
    {
        return select(mask, mul(a, b), value);
    }

    inline f32x8 div(f32x8 a, f32x8 b, mask32x8 mask, f32x8 value)
    {
    ...
    inline f64x4 unpackhi(f64x4 a, f64x4 b)
    {
        return _mm256_unpackhi_pd(a, b);
    }

    inline f64x4 unpacklo(f64x4 a, f64x4 b)
    {
    ...
    inline f64x4 bitwise_nand(f64x4 a, f64x4 b)
    {
        return _mm256_andnot_pd(a, b);
    }

    inline f64x4 bitwise_and(f64x4 a, f64x4 b)
    {
        return _mm256_and_pd(a, b);
    }

    inline f64x4 bitwise_or(f64x4 a, f64x4 b)
    {
        return _mm256_or_pd(a, b);
    }

    inline f64x4 bitwise_xor(f64x4 a, f64x4 b)
    {
        return _mm256_xor_pd(a, b);
    }

    inline f64x4 bitwise_not(f64x4 a)
    {
    ...
    inline f64x4 neg(f64x4 a)
    {
        return _mm256_sub_pd(_mm256_setzero_pd(), a);
    }

    inline f64x4 sign(f64x4 a)
    {
    ...
    inline f64x4 div(f64x4 a, f64x4 b)
    {
    ...
    inline f64x4 hadd(f64x4 a, f64x4 b)
    {
        return _mm256_hadd_pd(a, b);
    }

    inline f64x4 hsub(f64x4 a, f64x4 b)
    {
    ...
    inline f64x4 madd(f64x4 a, f64x4 b, f64x4 c)
    {
        // a + b * c
        return _mm256_fmadd_pd(b, c, a);
    }

    inline f64x4 msub(f64x4 a, f64x4 b, f64x4 c)
    {
        // b * c - a
        return _mm256_fmsub_pd(b, c, a);
    }

    inline f64x4 nmadd(f64x4 a, f64x4 b, f64x4 c)
    {
        // a - b * c
        return _mm256_fnmadd_pd(b, c, a);
    }

    inline f64x4 nmsub(f64x4 a, f64x4 b, f64x4 c)
    {
        // -(a + b * c)
    ...
    inline f64x4 lerp(f64x4 a, f64x4 b, f64x4 s)
    {
        // a * (1.0 - s) + b * s
        // (a - a * s) + (b * s)
        return madd(nmadd(a, a, s), b, s);
    ...
    inline f64x4 rcp(f64x4 a)
    {
        const __m256d one = _mm256_set1_pd(1.0);
        return _mm256_div_pd(one, a);
    }

    inline f64x4 rsqrt(f64x4 a)
    {
        const __m256d one = _mm256_set1_pd(1.0);
        return _mm256_div_pd(one, _mm256_sqrt_pd(a));
    }

    inline f64x4 sqrt(f64x4 a)
    {
    ...
    inline f64x4 min(f64x4 a, f64x4 b, mask64x4 mask)
    {
        return _mm256_and_pd(_mm256_castsi256_pd(mask), min(a, b));
    }

    inline f64x4 max(f64x4 a, f64x4 b, mask64x4 mask)
    {
        return _mm256_and_pd(_mm256_castsi256_pd(mask), max(a, b));
    }

    inline f64x4 add(f64x4 a, f64x4 b, mask64x4 mask)
    {
        return _mm256_and_pd(_mm256_castsi256_pd(mask), add(a, b));
    }

    inline f64x4 sub(f64x4 a, f64x4 b, mask64x4 mask)
    {
        return _mm256_and_pd(_mm256_castsi256_pd(mask), sub(a, b));
    }

    inline f64x4 mul(f64x4 a, f64x4 b, mask64x4 mask)
    {
        return _mm256_and_pd(_mm256_castsi256_pd(mask), mul(a, b));
    }

    inline f64x4 div(f64x4 a, f64x4 b, mask64x4 mask)
    {
    ...
    inline f64x4 min(f64x4 a, f64x4 b, mask64x4 mask, f64x4 value)
    {
        return select(mask, min(a, b), value);
    }

    inline f64x4 max(f64x4 a, f64x4 b, mask64x4 mask, f64x4 value)
    {
        return select(mask, max(a, b), value);
    }

    inline f64x4 add(f64x4 a, f64x4 b, mask64x4 mask, f64x4 value)
    {
        return select(mask, add(a, b), value);
    }

    inline f64x4 sub(f64x4 a, f64x4 b, mask64x4 mask, f64x4 value)
    {
        return select(mask, sub(a, b), value);
    }

    inline f64x4 mul(f64x4 a, f64x4 b, mask64x4 mask, f64x4 value)
    {
        return select(mask, mul(a, b), value);
    }

    inline f64x4 div(f64x4 a, f64x4 b, mask64x4 mask, f64x4 value)
    {
        return select(mask, div(a, b), value);
    }
