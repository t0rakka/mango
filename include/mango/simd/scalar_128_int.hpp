...
namespace mango::simd
{
    ...
    inline u8x16 u8x16_load_low(const u8* s) noexcept
    {
    ...
    inline u16x8 u16x8_load_low(const u16* s) noexcept
    {
    ...
    inline u32x4 u32x4_load_low(const u32* s) noexcept
    {
    ...
    inline s8x16 s8x16_load_low(const s8* s) noexcept
    {
    ...
    inline s16x8 s16x8_load_low(const s16* s) noexcept
    {
    ...
    inline s32x4 s32x4_load_low(const s32* s) noexcept
    {
