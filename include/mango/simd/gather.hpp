...
namespace simd {
    ...
    static inline float32x4 gather4(const float* address, int32x4 offset, float32x4 value, float32x4::mask mask)
    {
        return _mm_mask_i32gather_ps(value, reinterpret_cast<const float*>(address), offset, mask, 4);
    }

    static inline float64x2 gather2(const double* address, int32x4 offset, float64x2 value, float64x2::mask mask)
    {
        return _mm_mask_i32gather_pd(value, reinterpret_cast<const double*>(address), offset, mask, 8);
    }

    static inline uint32x4 gather4(const uint32* address, int32x4 offset, uint32x4 value, uint32x4::mask mask)
    {
        return _mm_mask_i32gather_epi32(value, reinterpret_cast<const int*>(address), offset, mask, 4);
    }

    static inline int32x4 gather4(const int32* address, int32x4 offset, int32x4 value, int32x4::mask mask)
    {
        return _mm_mask_i32gather_epi32(value, reinterpret_cast<const int*>(address), offset, mask, 4);
    }

    static inline uint64x2 gather2(const uint64* address, int32x4 offset, uint64x2 value, uint64x2::mask mask)
    {
        return _mm_mask_i32gather_epi64(value, reinterpret_cast<const long long*>(address), offset, mask, 8);
    }

    static inline int64x2 gather2(const int64* address, int32x4 offset, int64x2 value, int64x2::mask mask)
    {
        return _mm_mask_i32gather_epi64(value, reinterpret_cast<const long long*>(address), offset, mask, 8);
    }
    ...
    static inline float32x8 gather8(const float* address, int32x8 offset, float32x8 value, float32x8::mask mask)
    {
        return _mm256_mask_i32gather_ps(value, reinterpret_cast<const float*>(address), offset, mask, 4);
    }

    static inline float64x4 gather4(const double* address, int32x4 offset, float64x4 value, float64x4::mask mask)
    {
        return _mm256_mask_i32gather_pd(value, reinterpret_cast<const double*>(address), offset, mask, 8);
    }

    static inline uint32x8 gather8(const uint32* address, int32x8 offset, uint32x8 value, uint32x8::mask mask)
    {
        return _mm256_mask_i32gather_epi32(value, reinterpret_cast<const int*>(address), offset, mask, 4);
    }

    static inline int32x8 gather8(const int32* address, int32x8 offset, int32x8 value, int32x8::mask mask)
    {
        return _mm256_mask_i32gather_epi32(value, reinterpret_cast<const int*>(address), offset, mask, 4);
    }

    static inline uint64x4 gather4(const uint64* address, int32x4 offset, uint64x4 value, uint64x4::mask mask)
    {
        return _mm256_mask_i32gather_epi64(value, reinterpret_cast<const long long*>(address), offset, mask, 8);
    }

    static inline int64x4 gather4(const int64* address, int32x4 offset, int64x4 value, int64x4::mask mask)
    {
        return _mm256_mask_i32gather_epi64(value, reinterpret_cast<const long long*>(address), offset, mask, 8);
    }
