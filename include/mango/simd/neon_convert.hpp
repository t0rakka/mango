...
namespace mango::simd
{
    ...
    {
        u16x16 result;
        result.data[0] = vmovl_u8(vget_low_u8(s));
        result.data[1] = vmovl_u8(vget_high_u8(s));
        return result;
    }
    ...
    static inline u32x8 extend32x8(u8x16 s)
    {
        ...
        u32x8 result;
        result.data[0] = vmovl_u16(vget_low_u16(temp16x8));
        result.data[1] = vmovl_u16(vget_high_u16(temp16x8));
        return result;
    }
    ...
    static inline u64x4 extend64x4(u8x16 s)
    {
        ...
        u64x4 result;
        result.data[0] = vmovl_u32(vget_low_u32(temp32x4));
        result.data[1] = vmovl_u32(vget_high_u32(temp32x4));
        return result;
    }
    ...
    {
        u32x8 result;
        result.data[0] = vmovl_u16(vget_low_u16(s));
        result.data[1] = vmovl_u16(vget_high_u16(s));
        return result;
    }
    ...
    {
        u64x4 result;
        result.data[0] = vmovl_u32(vget_low_u32(s));
        result.data[1] = vmovl_u32(vget_high_u32(s));
        return result;
    }
    ...
    {
        s16x16 result;
        result.data[0] = vmovl_s8(vget_low_s8(s));
        result.data[1] = vmovl_s8(vget_high_s8(s));
        return result;
    }
    ...
    static inline s32x8 extend32x8(s8x16 s)
    {
        ...
        s32x8 result;
        result.data[0] = vmovl_s16(vget_low_s16(temp16x8));
        result.data[1] = vmovl_s16(vget_high_s16(temp16x8));
        return result;
    }
    ...
    static inline s64x4 extend64x4(s8x16 s)
    {
        ...
        s64x4 result;
        result.data[0] = vmovl_s32(vget_low_s32(temp32x4));
        result.data[1] = vmovl_s32(vget_high_s32(temp32x4));
        return result;
    }
    ...
    {
        s32x8 result;
        result.data[0] = vmovl_s16(vget_low_s16(s));
        result.data[1] = vmovl_s16(vget_high_s16(s));
        return result;
    }
    ...
    {
        s64x4 result;
        result.data[0] = vmovl_s32(vget_low_s32(s));
        result.data[1] = vmovl_s32(vget_high_s32(s));
        return result;
    }
    ...
    {
        f64x4 result;
        result.data[0] = vcvtq_f64_s64(vmovl_s32(vget_low_s32(s)));
        result.data[1] = vcvtq_f64_s64(vmovl_s32(vget_high_s32(s)));
        return result;
    }
    ...
    {
        f64x4 result;
        result.data[0] = vcvtq_f64_u64(vmovl_u32(vget_low_u32(s)));
        result.data[1] = vcvtq_f64_u64(vmovl_u32(vget_high_u32(s)));
        return result;
    }
    ...
    {
        f64x4 result;
        result.data[0] = vcvt_f64_f32(vget_low_f32(s));
        result.data[1] = vcvt_high_f64_f32(s);
        return result;
    }
    ...
    {
        int64x2_t lo = vcvtnq_s64_f64(vrndq_f64(s.data[0]));
        int64x2_t hi = vcvtnq_s64_f64(vrndq_f64(s.data[1]));
    ...
    {
        int64x2_t lo = vcvtnq_s64_f64(s.data[0]);
        int64x2_t hi = vcvtnq_s64_f64(s.data[1]);
        return vcombine_s32(vqmovn_s64(lo), vqmovn_s64(hi));
    }
    ...
    {
        uint64x2_t lo = vcvtnq_u64_f64(s.data[0]);
        uint64x2_t hi = vcvtnq_u64_f64(s.data[1]);
    ...
    {
        float32x2_t lo = vcvt_f32_f64(s.data[0]);
        float32x2_t hi = vcvt_f32_f64(s.data[1]);
    ...
    {
        float64x2_t lo64 = vcvtq_f64_s64(s.data[0]);
        float64x2_t hi64 = vcvtq_f64_s64(s.data[1]);
    ...
    {
        float64x2_t lo64 = vcvtq_f64_u64(s.data[0]);
        float64x2_t hi64 = vcvtq_f64_u64(s.data[1]);
        float32x2_t lo32 = vcvt_f32_f64(lo64);
        float32x2_t hi32 = vcvt_f32_f64(hi64);
        return vcombine_f32(lo32, hi32);
    }
    ...
    inline s32x4 truncate<s32x4>(f64x4 s)
    {
        s32 x = s32(get_component<0>(s.data[0]));
        s32 y = s32(get_component<1>(s.data[0]));
        s32 z = s32(get_component<0>(s.data[1]));
        s32 w = s32(get_component<1>(s.data[1]));
    ...
    inline s32x4 convert<s32x4>(f64x4 s)
    {
        s32 x = s32(get_component<0>(s.data[0]) + 0.5);
        s32 y = s32(get_component<1>(s.data[0]) + 0.5);
        s32 z = s32(get_component<0>(s.data[1]) + 0.5);
        s32 w = s32(get_component<1>(s.data[1]) + 0.5);
        return s32x4_set(x, y, z, w);
    }
    ...
    inline f32x4 convert<f32x4>(f64x4 s)
    {
        f32 x = f32(get_component<0>(s.data[0]));
        f32 y = f32(get_component<1>(s.data[0]));
        f32 z = f32(get_component<0>(s.data[1]));
        f32 w = f32(get_component<1>(s.data[1]));
