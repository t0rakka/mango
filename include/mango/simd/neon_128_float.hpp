...
namespace mango::simd
{
    ...
    template <unsigned int Index>
    inline f64x2 set_component(f64x2 a, f64 s)
    {
    ...
    template <unsigned int Index>
    inline f64 get_component(f64x2 a)
    {
        static_assert(Index < 2, "Index out of range.");
    ...
    inline f64x2 f64x2_set(f64 s)
    {
        return vdupq_n_f64(s);
    }

    inline f64x2 f64x2_set(f64 x, f64 y)
    {
    ...
    inline f64x2 div(f64x2 a, f64 b)
    {
    ...
    inline f64 dot2(f64x2 a, f64x2 b)
    {
