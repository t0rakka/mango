...
namespace mango::simd
{
    ...
    {
        f64x4 result;
        result.part[0] = __msa_fexupr_d(s);
        result.part[1] = __msa_fexupl_d(s);
        return result;
    }
    ...
    {
        s64x2 lo = __msa_ftrunc_s_d(s.part[0]);
        s64x2 hi = __msa_ftrunc_s_d(s.part[1]);
    ...
    {
        return __msa_fexdo_w(s.part[0], s.part[1]);
    }
