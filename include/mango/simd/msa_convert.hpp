...
namespace mango::simd
{
    ...
    {
        f64x4 result;
        result.data[0] = __msa_fexupr_d(s);
        result.data[1] = __msa_fexupl_d(s);
        return result;
    }
    ...
    {
        s64x2 lo = __msa_ftrunc_s_d(s.data[0]);
        s64x2 hi = __msa_ftrunc_s_d(s.data[1]);
    ...
    {
        return __msa_fexdo_w(s.data[0], s.data[1]);
    }
