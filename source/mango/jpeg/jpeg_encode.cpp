...
namespace
{
    ...
    u64 zigzag_sse41(s16* out, const s16* in)
    {
        ...
        const __m128i v0 = _mm_loadu_si128(src + 0); //  0 .. 7
        const __m128i v1 = _mm_loadu_si128(src + 1); //  8 .. 15
        const __m128i v2 = _mm_loadu_si128(src + 2); // 16 .. 23
        const __m128i v3 = _mm_loadu_si128(src + 3); // 24 .. 31
        const __m128i v4 = _mm_loadu_si128(src + 4); // 32 .. 39
        const __m128i v5 = _mm_loadu_si128(src + 5); // 40 .. 47
        const __m128i v6 = _mm_loadu_si128(src + 6); // 48 .. 55
        const __m128i v7 = _mm_loadu_si128(src + 7); // 56 .. 63
        ...
        __m128i row0 = shuffle(v0, 0, 1, z,  z, z, 2, 3,  z) |
                       shuffle(v1, z, z, 8,  z, 9, z, z, 10) |
                       shuffle(v2, z, z, z, 16, z, z, z,  z);
        ...
        __m128i row1 = shuffle(v0,  z,  z, z,  z,  z,  z, 4, 5) |
                       shuffle(v1,  z,  z, z,  z,  z, 11, z, z) |
                       shuffle(v2, 17,  z, z,  z, 18,  z, z, z) |
                       shuffle(v3,  z, 24, z, 25,  z,  z, z, z) |
                       shuffle(v4,  z, z, 32,  z,  z,  z, z, z);
        ...
        __m128i row2 = shuffle(v1, 12,  z,  z,  z,  z,  z,  z,  z) |
                       shuffle(v2,  z, 19,  z,  z,  z,  z,  z,  z) |
                       shuffle(v3,  z,  z, 26,  z,  z,  z,  z,  z) |
                       shuffle(v4,  z,  z,  z, 33,  z,  z,  z, 34) |
                       shuffle(v5,  z,  z,  z,  z, 40,  z, 41,  z) |
                       shuffle(v6,  z,  z,  z,  z,  z, 48,  z,  z);
        ...
        __m128i row3 = shuffle(v0,  z,  z,  z, 6, 7,  z,  z,  z) |
                       shuffle(v1,  z,  z, 13, z, z, 14,  z,  z) |
                       shuffle(v2,  z, 20,  z, z, z,  z, 21,  z) |
                       shuffle(v3, 27,  z,  z, z, z,  z,  z, 28);
        ...
        __m128i row4 = shuffle(v4, 35,  z,  z,  z,  z,  z,  z, 36) |
                       shuffle(v5,  z, 42,  z,  z,  z,  z, 43,  z) |
                       shuffle(v6,  z,  z, 49,  z,  z, 50,  z,  z) |
                       shuffle(v7,  z,  z,  z, 56, 57,  z,  z,  z);
        ...
        __m128i row5 = shuffle(v1,  z,  z, 15,  z,  z,  z,  z,  z) |
                       shuffle(v2,  z, 22,  z, 23,  z,  z,  z,  z) |
                       shuffle(v3, 29,  z,  z,  z, 30,  z,  z,  z) |
                       shuffle(v4,  z,  z,  z,  z,  z, 37,  z,  z) |
                       shuffle(v5,  z,  z,  z,  z,  z,  z, 44,  z) |
                       shuffle(v6,  z,  z,  z,  z,  z,  z,  z, 51);
        ...
        __m128i row6 = shuffle(v3,  z,  z,  z,  z,  z, 31,  z,  z) |
                       shuffle(v4,  z,  z,  z,  z, 38,  z, 39,  z) |
                       shuffle(v5,  z,  z,  z, 45,  z,  z,  z, 46) |
                       shuffle(v6,  z,  z, 52,  z,  z,  z,  z,  z) |
                       shuffle(v7, 58, 59,  z,  z,  z,  z,  z,  z);
        ...
        __m128i row7 = shuffle(v5,  z,  z,  z,  z, 47,  z,  z,  z) |
                       shuffle(v6, 53,  z,  z, 54,  z, 55,  z,  z) |
                       shuffle(v7,  z, 60, 61,  z,  z,  z, 62, 63);
