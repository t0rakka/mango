...
namespace fp64
{
    ...
    inline F atan2kf(F b, F a)
    {
        ...
        F u(0.00282363896258175373077393);
        u = madd(-0.0159569028764963150024414, u, t);
        u = madd( 0.0425049886107444763183594, u, t);
        u = madd(-0.0748900920152664184570312, u, t);
        u = madd( 0.106347933411598205566406, u, t);
        u = madd(-0.142027363181114196777344, u, t);
        u = madd( 0.199926957488059997558594, u, t);
        u = madd(-0.333331018686294555664062, u, t);
    ...
    F atan(F d)
    {
        ...
        q = select(one < s, q + i1, q);
        s = select(one < s, 1.0 / s, s);

        F t = s * s;
        F u = F(0.00282363896258175373077393);
        u = madd(-0.0159569028764963150024414, u, t);
        u = madd( 0.0425049886107444763183594, u, t);
        u = madd(-0.0748900920152664184570312, u, t);
        u = madd( 0.106347933411598205566406, u, t);
        ...
        t = select((q & i1) == i1, F(double_pi_2) - t, t);
        t = select((q & i2) == i2, -t, t);
        return t;
    }
