...
namespace mango::cocoa
{
    ...
    Keycode translateKeyCode(u32 code)
    {
        static const Keycode table [] =
        {
            ...
            KEYCODE_NONE, KEYCODE_NONE, KEYCODE_NUMPAD0, KEYCODE_NUMPAD1, KEYCODE_NUMPAD2, KEYCODE_NUMPAD3, KEYCODE_NUMPAD4, KEYCODE_NUMPAD5, KEYCODE_NUMPAD6, KEYCODE_NUMPAD7,
