...
namespace
{
    ...
    {
        // 1.0
        { 0x1903, Format(  8, Format::UNORM, Format::R,    8, 0, 0, 0), false, "RED" },
        { 0x1904, Format(  8, Format::UNORM, Format::G,    8, 0, 0, 0), false, "GREEN" },
        { 0x1905, Format(  8, Format::UNORM, Format::B,    8, 0, 0, 0), false, "BLUE" },
        { 0x1906, Format(  8, Format::UNORM, Format::A,    8, 0, 0, 0), false, "ALPHA" },
        { 0x1907, Format( 24, Format::UNORM, Format::RGB,  8, 8, 8, 0), false, "RGB" },
        { 0x1908, Format( 32, Format::UNORM, Format::RGBA, 8, 8, 8, 8), false, "RGBA" },

        // 1.1
        { 0x2A10, Format(  8, Format::UNORM, Format::RGB,   3,  3,  2,  0), false, "R3_G3_B2" },
        { 0x804F, Format( 16, Format::UNORM, Format::RGB,   4,  4,  4,  0), false, "RGB4" },
        { 0x8050, Format( 16, Format::UNORM, Format::RGB,   5,  5,  5,  0), false, "RGB5" },
        { 0x8051, Format( 24, Format::UNORM, Format::RGB,   8,  8,  8,  0), false, "RGB8" },
        { 0x8052, Format( 32, Format::UNORM, Format::RGB,  10, 10, 10,  0), false, "RGB10" },
        { 0x8053, Format( 48, Format::UNORM, Format::RGB,  12, 12, 12,  0), false, "RGB12" },
        { 0x8054, Format( 48, Format::UNORM, Format::RGB,  16, 16, 16,  0), false, "RGB16" },
        { 0x8055, Format(  8, Format::UNORM, Format::RGBA,  2,  2,  2,  2), false, "RGBA2" },
        { 0x8056, Format( 16, Format::UNORM, Format::RGBA,  4,  4,  4,  4), false, "RGBA4" },
        { 0x8057, Format( 16, Format::UNORM, Format::RGBA,  5,  5,  5,  1), false, "RGB5_A1" },
        { 0x8058, Format( 32, Format::UNORM, Format::RGBA,  8,  8,  8,  8), false, "RGBA8" },
        { 0x8059, Format( 32, Format::UNORM, Format::RGBA, 10, 10, 10,  2), false, "RGB10_A2" },
        { 0x805A, Format( 48, Format::UNORM, Format::RGBA, 12, 12, 12, 12), false, "RGBA12" },
        { 0x805B, Format( 64, Format::UNORM, Format::RGBA, 16, 16, 16, 16), false, "RGBA16" },

        // 1.2
        { 0x8032, Format(  8, Format::UNORM, Format::BGR,   2, 3, 3, 0), false, "UNSIGNED_BYTE_3_3_2" },
        { 0x8033, Format( 16, Format::UNORM, Format::ABGR,  4, 4, 4, 4), false, "UNSIGNED_SHORT_4_4_4_4" },
        { 0x8034, Format( 16, Format::UNORM, Format::ABGR,  1, 5, 5, 5), false, "UNSIGNED_SHORT_5_5_5_1" },
        { 0x8035, Format( 32, Format::UNORM, Format::ABGR,  8, 8, 8, 8), false, "UNSIGNED_INT_8_8_8_8" },
        { 0x8036, Format( 32, Format::UNORM, Format::ABGR,  2, 10, 10, 10), false, "UNSIGNED_INT_10_10_10_2" },
        { 0x8362, Format(  8, Format::UNORM, Format::RGB,   3, 3, 2, 0), false, "UNSIGNED_BYTE_2_3_3_REV" },
        { 0x8363, Format( 16, Format::UNORM, Format::BGR,   5, 6, 5, 0), false, "UNSIGNED_SHORT_5_6_5" },
        { 0x8364, Format( 16, Format::UNORM, Format::RGB,   5, 6, 5, 0), false, "UNSIGNED_SHORT_5_6_5_REV" },
        { 0x8365, Format( 16, Format::UNORM, Format::RGBA,  4, 4, 4, 4), false, "UNSIGNED_SHORT_4_4_4_4_REV" },
        { 0x8366, Format( 16, Format::UNORM, Format::RGBA,  5, 5, 5, 1), false, "UNSIGNED_SHORT_1_5_5_5_REV" },
        { 0x8367, Format( 32, Format::UNORM, Format::RGBA,  8, 8, 8, 8), false, "UNSIGNED_INT_8_8_8_8_REV" },
        { 0x8368, Format( 32, Format::UNORM, Format::RGBA, 10, 10, 10, 2), false, "UNSIGNED_INT_2_10_10_10_REV" },
        { 0x80E0, Format( 24, Format::UNORM, Format::BGR,   8, 8, 8, 0), false, "BGR" },
        { 0x80E1, Format( 32, Format::UNORM, Format::BGRA,  8, 8, 8, 8), false, "BGRA" },

        // 2.1
        { 0x8C40, Format( 24, Format::UNORM, Format::RGB,   8,  8,  8,  0),  true, "SRGB" },
        { 0x8C41, Format( 24, Format::UNORM, Format::RGB,   8,  8,  8,  0),  true, "SRGB8" },
        { 0x8C42, Format( 32, Format::UNORM, Format::RGBA,  8,  8,  8,  8),  true, "SRGB_ALPHA" },
        { 0x8C43, Format( 32, Format::UNORM, Format::RGBA,  8,  8,  8,  8),  true, "SRGB8_ALPHA8" },

        // 3.0
        { 0x8814, Format(128, Format::FLOAT32, Format::RGBA, 32, 32, 32, 32), false, "RGBA32F" },
        { 0x8815, Format( 96, Format::FLOAT32, Format::RGB,  32, 32, 32,  0), false, "RGB32F" },
        { 0x881A, Format( 64, Format::FLOAT16, Format::RGBA, 16, 16, 16, 16), false, "RGBA16F" },
        { 0x881B, Format( 48, Format::FLOAT16, Format::RGB,  16, 16, 16,  0), false, "RGB16F" },
        //{ 0x8C3A, Format(), false, "R11F_G11F_B10F" },
        //{ 0x8C3B, Format(), false, "UNSIGNED_INT_10F_11F_11F_REV" },
        //{ 0x8C3D, Format(), false, "RGB9_E5" },
        { 0x8C3E, Format( 32, Format::UNORM, Format::RGBA, 9, 9, 9, 5), false, "UNSIGNED_INT_5_9_9_9_REV" },
        { 0x8D70, Format(128, Format::UINT,  Format::RGBA, 32, 32, 32, 32), false, "RGBA32UI" },
        { 0x8D71, Format( 96, Format::UINT,  Format::RGB,  32, 32, 32,  0), false, "RGB32UI" },
        { 0x8D76, Format( 64, Format::UINT,  Format::RGBA, 16, 16, 16, 16), false, "RGBA16UI" },
        { 0x8D77, Format( 48, Format::UINT,  Format::RGB,  16, 16, 16,  0), false, "RGB16UI" },
        { 0x8D7C, Format( 32, Format::UINT,  Format::RGBA,  8,  8,  8,  8), false, "RGBA8UI" },
        { 0x8D7D, Format( 24, Format::UINT,  Format::RGB,   8,  8,  8,  0), false, "RGB8UI" },
        { 0x8D82, Format(128, Format::SINT,  Format::RGBA, 32, 32, 32, 32), false, "RGBA32I" },
        { 0x8D83, Format( 96, Format::SINT,  Format::RGB,  32, 32, 32,  0), false, "RGB32I" },
        { 0x8D88, Format( 64, Format::SINT,  Format::RGBA, 16, 16, 16, 16), false, "RGBA16I" },
        { 0x8D89, Format( 48, Format::SINT,  Format::RGB,  16, 16, 16,  0), false, "RGB16I" },
        { 0x8D8E, Format( 32, Format::SINT,  Format::RGBA,  8,  8,  8,  8), false, "RGBA8I" },
        { 0x8D8F, Format( 24, Format::SINT,  Format::RGB,   8,  8,  8,  0), false, "RGB8I" },
        { 0x8227, Format( 16, Format::UNORM, Format::RG,    8,  8,  0,  0), false, "RG" },
        { 0x8229, Format(  8, Format::UNORM, Format::R,     8,  0,  0,  0), false, "R8" },
        { 0x822A, Format( 16, Format::UNORM, Format::R,    16,  0,  0,  0), false, "R16" },
        { 0x822B, Format( 16, Format::UNORM, Format::RG,    8,  8,  0,  0), false, "RG8" },
        { 0x822C, Format( 32, Format::UNORM, Format::RG,   16, 16,  0,  0), false, "RG16" },
        { 0x822D, Format( 16, Format::FLOAT16, Format::R,    16,  0,  0,  0), false, "R16F" },
        { 0x822E, Format( 32, Format::FLOAT32, Format::R,    32,  0,  0,  0), false, "R32F" },
        { 0x822F, Format( 32, Format::FLOAT16, Format::RG,   16, 16,  0,  0), false, "RG16F" },
        { 0x8230, Format( 64, Format::FLOAT32, Format::RG,   32, 32,  0,  0), false, "RG32F" },
        { 0x8231, Format(  8, Format::SINT,  Format::R,     8,  0,  0,  0), false, "R8I" },
        { 0x8232, Format(  8, Format::UINT,  Format::R,     8,  0,  0,  0), false, "R8UI" },
        { 0x8233, Format( 16, Format::SINT,  Format::R,    16,  0,  0,  0), false, "R16I" },
        { 0x8234, Format( 16, Format::UINT,  Format::R,    16,  0,  0,  0), false, "R16UI" },
        { 0x8235, Format( 32, Format::SINT,  Format::R,    32,  0,  0,  0), false, "R32I" },
        { 0x8236, Format( 32, Format::UINT,  Format::R,    32,  0,  0,  0), false, "R32UI" },
        { 0x8237, Format( 16, Format::SINT,  Format::RG,    8,  8,  0,  0), false, "RG8I" },
        { 0x8238, Format( 16, Format::UINT,  Format::RG,    8,  8,  0,  0), false, "RG8UI" },
        { 0x8239, Format( 32, Format::SINT,  Format::RG,   16, 16,  0,  0), false, "RG16I" },
        { 0x823A, Format( 32, Format::UINT,  Format::RG,   16, 16,  0,  0), false, "RG16UI" },
        { 0x823B, Format( 64, Format::SINT,  Format::RG,   32, 32,  0,  0), false, "RG32I" },
        { 0x823C, Format( 64, Format::UINT,  Format::RG,   32, 32,  0,  0), false, "RG32UI" },

        // 3.1
        { 0x8F94, Format(  8, Format::SNORM, Format::R,     8,  0,  0,  0), false, "R8_SNORM" },
        { 0x8F95, Format( 16, Format::SNORM, Format::RG,    8,  8,  0,  0), false, "RG8_SNORM" },
        { 0x8F96, Format( 24, Format::SNORM, Format::RGB,   8,  8,  8,  0), false, "RGB8_SNORM" },
        { 0x8F97, Format( 32, Format::SNORM, Format::RGBA,  8,  8,  8,  8), false, "RGBA8_SNORM" },
        { 0x8F98, Format( 16, Format::SNORM, Format::R,    16,  0,  0,  0), false, "R16_SNORM" },
        { 0x8F99, Format( 32, Format::SNORM, Format::RG,   16, 16,  0,  0), false, "RG16_SNORM" },
        { 0x8F9A, Format( 48, Format::SNORM, Format::RGB,  16, 16, 16,  0), false, "RGB16_SNORM" },
        { 0x8F9B, Format( 64, Format::SNORM, Format::RGBA, 16, 16, 16, 16), false, "RGBA16_SNORM" },

        // 3.3
        { 0x906F, Format( 32, Format::UINT,  Format::RGBA, 10, 10, 10,  2), false, "RGB10_A2UI" },
        { 0x8D9F, Format( 32, Format::UNORM, Format::RGBA, 10, 10, 10,  2), false, "INT_2_10_10_10_REV" },

        // 4.1
        { 0x8D62, Format( 16, Format::UNORM, Format::RGB,   5,  6,  5,  0), false, "RGB565" },

        // GL_EXT_texture
        { 0x803B, Format(  8, Format::UNORM,   Format::A,  4, 0, 0, 0), false, "ALPHA4" },
        { 0x803C, Format(  8, Format::UNORM,   Format::A,  8, 0, 0, 0), false, "ALPHA8" },
        { 0x803D, Format( 16, Format::UNORM,   Format::A, 12, 0, 0, 0), false, "ALPHA12" },
        { 0x803D, Format( 16, Format::UNORM,   Format::A, 16, 0, 0, 0), false, "ALPHA16" },

        // GL_EXT_texture_integer
        { 0x8D90, Format(  8, Format::SINT,    Format::A,  8, 0, 0, 0), false, "ALPHA8I" },
        { 0x8D7E, Format(  8, Format::UINT,    Format::A,  8, 0, 0, 0), false, "ALPHA8UI" },
        { 0x8D8A, Format( 16, Format::SINT,    Format::A, 16, 0, 0, 0), false, "ALPHA16I" },
        { 0x8D78, Format( 16, Format::UINT,    Format::A, 16, 0, 0, 0), false, "ALPHA16UI" },
        { 0x8D84, Format( 32, Format::SINT,    Format::A, 32, 0, 0, 0), false, "ALPHA32I" },
        { 0x8D72, Format( 32, Format::UINT,    Format::A, 32, 0, 0, 0), false, "ALPHA32UI" },

        // GL_{ATI,ARB,APPLE}_texture_float
        { 0x881C, Format( 16, Format::FLOAT16, Format::A, 16, 0, 0, 0), false, "ALPHA16F" },
        { 0x8816, Format( 32, Format::FLOAT32, Format::A, 32, 0, 0, 0), false, "ALPHA32F" },
    };
