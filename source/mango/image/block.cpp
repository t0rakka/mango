...
namespace
{
    ...
    const TextureCompression g_blockTable[] =
    {
        ...
        TextureCompression(
            ...
            4, 4, 1, 16, FORMAT_ASTC_FP16, 
            decode_surface_astc, nullptr
        ),
