...
namespace
{
    ...
    std::string getImageFormatExtension(ConstMemory memory)
    {
        ...
        const Signature signatures [] =
        {
            ...
            { { 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0x000f, ".ico" },
            { { 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0x000f, ".cur" },
