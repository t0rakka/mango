...
namespace
{
    ...
    struct HeaderTGA
    {
        ...
        const u8* parse(ConstMemory memory)
        {
            ...
            printLine(Print::Debug, "  image_type:    {}", image_type);
            printLine(Print::Debug, "  pixel_size:    {}", pixel_size);
            printLine(Print::Debug, "  colormap_type: {}", colormap_type);
            printLine(Print::Debug, "  colormap_bits: {}", colormap_bits);
            printLine(Print::Debug, "  colormap:      [{}, {}]", colormap_origin, colormap_origin + colormap_length);
            printLine(Print::Debug, "  descriptor:    {:#x}", descriptor);
            printLine(Print::Debug, "  id_length:     {}", id_length);
