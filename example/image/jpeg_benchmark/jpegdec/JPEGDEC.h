...
#define MCU0 (X_DCTSIZE * 0)
#define MCU1 (X_DCTSIZE * 1)
#define MCU2 (X_DCTSIZE * 2)
#define MCU3 (X_DCTSIZE * 3)
#define MCU4 (X_DCTSIZE * 4)
#define MCU5 (X_DCTSIZE * 5)
...
typedef struct jpeg_image_tag
{
    ...
    int16_t sMCUs[X_DCTSIZE * MAX_MCU_COUNT]; // 4:2:0 needs 6 DCT blocks per MCU
    int16_t sQuantTable[X_DCTSIZE*4]; // quantization tables
